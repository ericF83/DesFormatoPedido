    ...
    public partial class FRM_tallas : Form
    {
        ...
        public string Art()
        {
            ...
            var dValue1 = from row in FP.Uni.AsEnumerable()
                          ...
                          && row.Field<string>("Familia") == Estilo
                          //&& row.Field<int>("C") == 3
                          select row.Field<string>("Articulo");
        ...
        public bool habilitar(string talla)
        {
            ...
            List<string> NarviSt = new List<string>() { "DC" };
            List<string> NarviClr = new List<string>() { "ROJO", "NEGRO", "GRIS" };
            List<string> NarviT = new List<string>() { "5XL" };
            if (Modelo == "NARVI" && NarviSt.Contains(Estilo) && NarviT.Contains(talla))
                ret = false;
